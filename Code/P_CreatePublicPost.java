...
public class P_CreatePublicPost extends AppCompatActivity {

    public String userNumber,id;
    public String date1,time1;
    private RequestQueue requestQueue;
    private static final String log = "http://whatshappening.16mb.com/add_p_friends.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custom = new P_CustomDateTimePicker(this,
                new P_CustomDateTimePicker.ICustomDateTimeListener() {
                            ...
                            public void onResponse(String response) {
                                try {
                                    ...
                                    if (!response.equals("0")) {
                                        ...
                                        id = response;
                                        Log.e("Id value: ", id);
                                        Intent send = new Intent(P_CreatePublicPost.this, PFriends.class);
    ...
    P_CustomDateTimePicker custom;

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.p_activity_event_details, menu);
        return true;
    }
