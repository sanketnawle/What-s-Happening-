...
public class NoResponse extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url ="http://whatshappening.16mb.com/getNoResponseFriends.php?id="+event_id;

        loading = ProgressDialog.show(NoResponse.this, "Please wait...", "Fetching...", false, false);
        ...
        StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                showJSON(response);
                Log.e("Response in No response", response);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Log.e("Error:", "OnErrorResponse");
                Toast.makeText(NoResponse.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(NoResponse.this);
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            ListView listView = (ListView) findViewById(R.id.noResponseListView);
            FriendsList.addAll(Arrays.asList(friends));
            // FriendsList.add(friend_name+"\n"+friend_no);
            listAdapter = new ArrayAdapter<String>(this, R.layout.single_no_response, FriendsList);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position,
                    ...
                    Intent send = new Intent(NoResponse.this, Profile_MainScreen.class);
                    send.putExtra("userNumber", friend_phone);
                    send.putExtra("Calling", "NoResponse");
                    startActivity(send);
