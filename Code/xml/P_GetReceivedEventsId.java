...
public class P_GetReceivedEventsId extends Activity{
  ...
  //  final String getId1[]={""};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url = "http://whatshappening.16mb.com/getReceivedPEventsId.php?id="+userNumber;
        ...
        StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if(response.equals("{\"result\":[]}")){
                    Toast.makeText(P_GetReceivedEventsId.this, "No events to show", Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(P_GetReceivedEventsId.this);
    ...
    public void showJSON(String response) {
      ...
      /*  getId1 = new String[getId.length];
        ...
        Intent send = new Intent(this, P_ReceivedEvents.class);
