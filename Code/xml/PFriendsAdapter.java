...
public class PFriendsAdapter extends BaseAdapter{


    public List<SelectPFriend> _data;
    private ArrayList<SelectPFriend> arraylist;
    public String userNumber,id;
    private StringRequest request;
    private RequestQueue requestQueue;
    Context _c;
    ViewHolder v;
    P_RoundImage roundedImage;
    public static final String log = "http://whatshappening.16mb.com/send_p_friends.php";

    public PFriendsAdapter(List<SelectPFriend> selectPFriends, Context context) {
        _data = selectPFriends;
        Log.e("_data in RequestAdapter",_data.toString());
        _c = context;
        Log.e("Contxt in ReqAdapter",_c.toString());
        this.arraylist = new ArrayList<SelectPFriend>();
    ...
    public View getView(int i, View convertView, ViewGroup viewGroup) {
        ...
        Log.e("Entered:", "getView of PFriendsAdapter");
        ...
        final SelectPFriend data = (SelectPFriend) _data.get(i);
        v.name.setText(data.getName());
        v.phone.setText(data.getPhone());
        v.imageView.setImageBitmap(data.getThumb());
        Log.e("Name in PFriendsAdapter", data.getName());
        ...
        try {
            ...
            roundedImage = new P_RoundImage(bm);
            ...
            public void onClick(View view) {
              ...
              /*  final String requestName;
               ...
               final Button add = (Button) view;
                ...
                final String url = Config1.DATA_URL + userNo2 + "&phone_no=" + phone_no;
