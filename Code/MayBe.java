...
public class MayBe extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String url ="http://whatshappening.16mb.com/getMayBeFriends.php?id="+event_id;

        loading = ProgressDialog.show(MayBe.this, "Please wait...", "Fetching...", false, false);
        ...
        StringRequest stringRequest = new StringRequest(url, new Response.Listener<String>() {
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(MayBe.this, error.getMessage().toString(), Toast.LENGTH_LONG).show();
            }
        });

        RequestQueue requestQueue = Volley.newRequestQueue(MayBe.this);
    ...
    private void showJSON(String response) {
        ...
        try {
            ...
            ListView listView = (ListView) findViewById(R.id.mayBeListView);
            FriendsList.addAll(Arrays.asList(friends));
            // FriendsList.add(friend_name+"\n"+friend_no);
            listAdapter = new ArrayAdapter<String>(this, R.layout.single_may_be, FriendsList);
            ...
            listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position,
                    ...
                    Intent send = new Intent(MayBe.this, Profile_MainScreen.class);
                    send.putExtra("userNumber", friend_phone);
                    send.putExtra("Calling", "MayBe");
                    startActivity(send);
